...
function AgendaApp() {
  ...
  const onEditarClick = (contacto) => { setContactoEnEdicion(contacto); setError(""); };
  const onCancelarEdicion = () => { setContactoEnEdicion(null); };
  const irAVerContactos = () => { setVista("contactos"); setContactoEnEdicion(null); };
  const irACrearContacto = () => { setVista("crear"); setContactoEnEdicion(null); setBusqueda(""); };
    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          <Route path="/" element={<ProtectedRoute><AgendaApp /></ProtectedRoute>} />
        </Routes>
      </AuthProvider>
    </BrowserRouter>
  );
